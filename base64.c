...
int main()
{
    const char data[] = {'a', 'b', '2', '3', '4'};
    const char *inData = "nGxzGdpMFuOS7Ur5ACCbp1+UP78GI+Pv/egvPq60ozdVpGx+3D7gAn0Eiect2YAwPb5eKZ0JCuyxaXVi35cuO/YZUxjE8O8ZS3F7bvM2xlM";

    unsigned char out[1024] = {0x0};
    unsigned char decode[1024] = {0x0};
    size_t ret = 0;
    
    ret = Base64Encode((unsigned char*)data, sizeof(data), out, 1024);
    
    ret = Base64Decode(out, ret, decode, 1024);
